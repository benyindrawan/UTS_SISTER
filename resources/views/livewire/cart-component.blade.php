                ...
                <ul class="products-cart">
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure><img src="{{asset('assets/images/products/skin-01.jpg')}}" alt=""></figure>
                        </div>
                        <div class="product-name">
                            <a class="link-to-product" href="#">Skincare</a>
                        </div>
                    ...
                    <li class="pr-cart-item">
                        <div class="product-image">
                            <figure><img src="{{asset('assets/images/products/skin-02.jpg')}}" alt=""></figure>
                        </div>
                        <div class="product-name">
                            <a class="link-to-product" href="#">Skincare baru</a>
                        </div>
                        <div class="price-field produtc-price">
                            <p class="price">$256.00</p>
                        </div>
